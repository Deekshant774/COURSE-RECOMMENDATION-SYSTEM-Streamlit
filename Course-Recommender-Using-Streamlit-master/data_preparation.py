...
def prepare_data(df):
    ...
    destination_path = destination_path = r"C:\Users\deeks\Downloads\Course-Recommender-Using-Streamlit-master\Course-Recommender-Using-Streamlit-master\data\coursera-courses.csv"
    df.to_csv(destination_path, index=False)

def main():

    source_path1 = r"C:\Users\deeks\Downloads\Course-Recommender-Using-Streamlit-master\Course-Recommender-Using-Streamlit-master\data\coursera-courses-overview.csv"
    source_path2 = r"C:\Users\deeks\Downloads\Course-Recommender-Using-Streamlit-master\Course-Recommender-Using-Streamlit-master\data\coursera-individual-courses.csv"
    df_overview = pd.read_csv(r"C:\Users\deeks\Downloads\Course-Recommender-Using-Streamlit-master\Course-Recommender-Using-Streamlit-master\data\coursera-courses-overview.csv")
    df_individual = pd.read_csv(r"C:\Users\deeks\Downloads\Course-Recommender-Using-Streamlit-master\Course-Recommender-Using-Streamlit-master\data\coursera-individual-courses.csv")
